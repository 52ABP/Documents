...
## 52ABP-CLI v1.0.3 (2022年1月6日)

- 单元测试项目生成代码修改
- Application 模块增加权限配置和映射配置注册器
- 生成的各个模块引用的基础模块调整
- 本地化资源调整为嵌入式资源
...
- 升级代码生成器，生成的实体，增加注释描述字段。版本号：v5.0.2
- 修复已知的bug
...
- 关闭紧凑样式的引入，如果要开启，地址`src\styles.less` 取消注释即可。
- 优化for循环为foreach
- 调整前端过时的接口与方法
- 修复多语言显示问题
- 增加page-filter功能
